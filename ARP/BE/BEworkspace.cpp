...
#ifdef LINUX
pthread_mutex_t BucketElimination::BEworkspace::stopSignalMutex =
...
#else
    pthread_mutex_lock(&BucketElimination::BEworkspace::stopSignalMutex);
    stop_signalled = bews->_StopAndExit;
    pthread_mutex_unlock(&BucketElimination::BEworkspace::stopSignalMutex);
#endif
		if (0 != stop_signalled) {
			break ;
			}
