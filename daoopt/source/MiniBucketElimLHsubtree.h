...
public :
	...
	int Delete(void) ;
	inline MBLHSubtreeNode(void) : _H(NULL), _RootVar(-1), _v(-1), _Parent(NULL), _idxWRTparent(-1), _k(-1), _depth2go(-1), _OutputFunctionSize(-1), _OutputFunction(NULL), _idxVarMappingComputed(false), _nTimesComputed(0), _nVarsInstantiated(-1)
	{
	}
